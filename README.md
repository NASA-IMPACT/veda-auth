...
1. [_Optional_] Set `DELTA_BACKEND_EXTERNAL_ROLE_ARN` in environment configuration. Enables delta-backend-role (generated by veda-stac-ingestor) to assume the data-access-role.
